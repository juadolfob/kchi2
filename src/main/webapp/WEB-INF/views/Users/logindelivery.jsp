...
<body>
  <header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-light opacity-90 ps-2 pe-5 py-0">
        <div class="container-fluid px-5 py-0">
          <a class="navbar-brand" href="#">
            <img src="res/atos-blue-logo.jfif" alt="atos white logo" height="30">
          </a>
        </div>
      </nav>
</header>
      ...
      <div class="row justify-content-around">
        <div class="col-4">
          ...
          <div class="form-group">
            ...
            <div class="icon-input">
              <select  class="form-control padding-inputs redondeo" name="ldrole">
        ...
        <div class="col-4">
          ...
          <figure class="figure">
            <img src="res/imgsignin.png" style="width: 90rem;" class="figure-img img-fluid rounded" alt="...">
